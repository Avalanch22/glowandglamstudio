    ...
    <div className="relative">
      ...
      <section className="py-12 md:py-20 px-4 md:px-6 relative">
        <Reveal className="container mx-auto">
          ...
          <div className="-mx-4 md:mx-0 overflow-x-auto md:overflow-visible pb-3 md:pb-0 flex md:grid md:grid-cols-5 gap-3 px-4 md:px-0 scroll-smooth snap-x snap-mandatory">
            {SERVICES.map((s) => (
              <a
                key={s.title}
                href={s.href}
                className="group powder-card bg-card/40 hover:bg-card/70 p-6 md:p-8 flex flex-col justify-between gap-6 md:gap-8 border border-border/40 hover:border-primary/50 rounded-md transition-all duration-300 min-w-[200px] sm:min-w-[220px] md:min-w-0 snap-start flex-shrink-0 md:flex-shrink"
              >
